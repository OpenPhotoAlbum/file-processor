...
export class VideoProcessor extends BaseProcessor {
    ...
    async validate(file) {
        ...
        try {
            ...
            this.logger.error(`Unexpected error validating video: ${safePath}`, error);
            return false;
        }
    }
    /**
    ...
    async extract(file) {
        ...
        try {
            ...
            this.logger.error(`Failed to extract video metadata: ${safePath}`, error);
