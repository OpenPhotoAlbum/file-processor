...
export class GNISProvider {
    ...
    logger = new Logger('GNIS Provider');
    connection = null;
     ...
     */
    determineRelationship(distance, record) {
     ...
     */
    calculateConfidence(distance, record, relationship) {
        let confidence = 1.0;
