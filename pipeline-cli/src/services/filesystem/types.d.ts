...
export declare const MEDIA_EXTENSIONS: {
    readonly IMAGE: readonly [".jpg", ".jpeg", ".png", ".gif", ".bmp", ".tiff", ".tif", ".webp", ".heic", ".heif", ".raw", ".cr2", ".nef", ".arw"];
    readonly VIDEO: readonly [".mp4", ".avi", ".mov", ".mkv", ".webm", ".flv", ".wmv", ".m4v", ".3gp"];
    readonly AUDIO: readonly [".mp3", ".wav", ".flac", ".aac", ".ogg", ".wma", ".m4a"];
};
/**
 * Common sidecar file extensions
 */
export declare const SIDECAR_EXTENSIONS: readonly [".xmp", ".json", ".xml", ".txt", ".yaml", ".yml"];
