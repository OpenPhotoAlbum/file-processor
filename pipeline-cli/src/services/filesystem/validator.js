...
export class FileSystemValidator {
    logger = new Logger('FileSystem Validator');
    validationErrors = createValidationErrorFactory(this.logger);
    pathErrors = createPathErrorFactory(this.logger);
    /**
    ...
    async validatePath(inputPath) {
        ...
        try {
            ...
            try {
                ...
                result.errors.push(`Path resolution failed: ${error.message}`);
     ...
     */
    async validatePathSecurity(filePath) {
