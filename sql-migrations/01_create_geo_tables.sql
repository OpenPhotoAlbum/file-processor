-- Migration: Create geolocation tables structure
...
CREATE TABLE IF NOT EXISTS `geo_cities` (
  ...
  CONSTRAINT `geo_cities_country_code_foreign` FOREIGN KEY (`country_code`) REFERENCES `geo_countries` (`country_code`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;