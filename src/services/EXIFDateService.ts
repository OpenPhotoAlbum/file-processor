...
// Remove logger import - not needed for this service
...
export class EXIFDateService {
  // Logger removed - using simple implementation for this service
  ...
  async getExifDate(file: string): Promise<string | null> {
    try {
      ...
      // Failed to read EXIF date
      return null;
    }
  }
}

export const exifDateService = new EXIFDateService();